...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Regra de Três', 'Razao e Proporção', 'Estatística' , 'Probabilidade', 'Geometria Plana', ' Porcentagem', 'Outros'],
            datasets: [{
                data: [15, 10, 15, 7, 15, 7, 31],
                backgroundColor: [
                    'rgb(255, 0, 0)',
                    'rgb(0, 255, 0)',
                    'rgb(0, 0, 255)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Regra de Três'){
                    window.location.href=('../Matematica/matematica-regra-de-tres.html')
                }
                else if(label=='Razao e Proporção'){
                    window.location.href=('../Matematica/matematica-razao-proporcao.html')
                }
                if(label=='Estatística'){
                    window.location.href=('../Matematica/matematica-estatistica.html')
                }
                if(label=='Probabilidade'){
                    window.location.href=('../Matematica/matematica-probabilidade.html')
                }
                if(label=='Geometria Plana'){
                    window.location.href=('../Matematica/matematica-geometria-plana.html')
                }
                if(label=='Porcentagem'){
                    window.location.href=('../Matematica/matematica-probabilidade.html')
                }
