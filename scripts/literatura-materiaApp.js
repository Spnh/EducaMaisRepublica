...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Literatura Brasileira', 'Gêneros/Movimentos literários' ,'Literatura Portuguesa', 'Literatura Universal'],
            datasets: [{
                data: [45, 37, 8, 10],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Literatura Brasileira'){
                    window.location.href=('../Literatura/literatura-brasileira.html')
                }
                else if(label=='Gêneros/Movimentos literários'){
                    window.location.href=('../Literatura/literatura-generos-movimentos-literarios.html')
                }
                if(label=='Literatura Portuguesa'){
                    window.location.href=('../Literatura/literatura-portuguesa.html')
                }

                if(label=='Literatura Universal'){
                    window.location.href=('../Literatura/literatura-universal.html')
                }
