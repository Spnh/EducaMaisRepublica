...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Geografia Física', 'Geografia Politica', 'Geografia Ambiental' , 'Urbanização'],
            datasets: [{
                data: [20, 50, 5, 25 ],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Geografia Física'){
                    window.location.href=('geografia-fisica.html')
                }
                else if(label=='Geografia Politica'){
                    window.location.href=('geografia-geopolitica.html')
                }
                if(label=='Urbanização'){
                    window.location.href=('geografia-urbanizacao.html')
                }

                if(label=='Geografia Ambiental'){
                    window.location.href=('geografia-meioambiente-impactos-sustentabilidade.html')
                }
