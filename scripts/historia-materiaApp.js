...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Idade Média', 'Estado Novo', 'Idade Moderna' , 'Brasil Colônia'],
            datasets: [{
                data: [10, 50, 10, 30 ],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Idade Média'){
                    window.location.href=('../historia/historia-idademedia.html')
                }
                else if(label=='Estado Novo'){
                    window.location.href=('../historia/historia-estadonovo-populismo.html')
                }
                if(label=='Idade Moderna'){
                    window.location.href=('../historia/historia-idademoderna.html')
                }

                if(label=='Brasil Colônia'){
                    window.location.href=('../historia/historia-brasilcolonia.html')
                }
