...
function abreTopico(topico){  
   window.open(topico + ".html","_parent")
}
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Cidadania', 'Desigualdade Social' ,'Diversidade Cultural', 'Movimentos Sociais','Mundo do trabalho', 'Política'],
            datasets: [{
                data: [20, 16, 15, 19, 10, 10],
                backgroundColor: [
                  'rgb(255, 0, 0)',
                  'rgb(0, 255, 0)',
                  'rgb(0, 0, 255)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Substantivos e Adjetivos'){
                    window.location.href=('../Espanhol/espanhol-substantivos-adjetivos.html')
                }
                else if(label=='Verbos'){
                    window.location.href=('../Espanhol/espanhol-verbos.html')
                }
                if(label=='Advérbios'){
                    window.location.href=('../Espanhol/espanhol-adverbios.html')
                }

                if(label=='Artigos Definidos e Indefinidos'){
                    window.location.href=('../Espanhol/espanhol-artigos-definidos-indefinidos.html')
                }
                
                if(label=='Subordinantes'){
                  window.location.href=('../Espanhol/espanhol-subordinantes.html')
              }
                  
              if(label=='Coordinantes'){
                window.location.href=('../Espanhol/espanhol-coordinantes.html')
              }
               if(label=='Palavras Homônimas'){
              window.location.href=('../Espanhol/espanhol-palavras-homonimas.html')
          }
...
function search() {
  ...
  var txtBusca =removerAcentos(texto).toLowerCase();
    ...
    if(txtBusca=='matematica' ||txtBusca=='matematic' ||txtBusca=='mat' ) {
     ...
     alert("Não foi possível encontrar a página! Tente procurar pela página de conteudo Programático!")
    }
  }