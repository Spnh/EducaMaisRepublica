...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Isomeria', 'Tabela Periódica', 'Ligações' , 'Átomos', 'Funções Inorgânicas'],
            datasets: [{
                data: [20,10 , 20, 20 ,30],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Isomeria'){
                    window.location.href=('quimica-isomeria.html')
                }
                else if(label=='Tabela Periódica'){
                    window.location.href=('quimica-tabela-periodica.html')
                }
                if(label=='Ligações'){
                    window.location.href=('quimica-ligacoes-quimicas.html')
                }

                if(label=='Átomos'){
                    window.location.href=('quimica-atomos.html')
                }
                
                if(label=='Funções Inorgânicas'){
                  window.location.href=('quimica-funcoes-inorganicas.html')
              }
