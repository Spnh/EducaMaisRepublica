...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Citologia', 'Ecologia', 'Reprodução' , 'Genética', 'Sistema Nervoso', 'Metabolismo e Nutrição', 'Materias que caem mas não sao muito importantes'],
            datasets: [{
                data: [35, 15, 10, 10, 8, 7, 4 ],
                backgroundColor: [
                    'rgb(255, 0, 0)',
                    'rgb(0, 255, 0)',
                    'rgb(0, 0, 255)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Citologia'){
                    window.location.href=('../biologia/biologia-citologia.html')
                }
                else if(label=='Ecologia'){
                    window.location.href=('../biologia/biologia-ecologia.html')
                }
                if(label=='Reprodução'){
                    window.location.href=('../biologia/biologia-reproducao.html')
                }

                if(label=='Genética'){
                    window.location.href=('../biologia/biologia-genetica.html')
                }
                if(label=='Sistema Nervoso'){
                    window.location.href=('../biologia/biologia-sistema-nervoso.html')
                }
                if(label=='Metabolismo e Nutrição'){
                    window.location.href=('../biologia/biologia-metabolismo-nutricao.html')
                }
                if(label == 'Materias que caem mas não sao muito importantes'){
                  window.location.href=('../biologia/biologia-materias-tambem-caem.html')
                }
            }
        });
