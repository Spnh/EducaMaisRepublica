...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['ingles-compreensao-de-texto', 'ingles-interpretacao-de-figuras-de-linguagem', 'ingles-gramatica-estrutura-da-lingua'],
            datasets: [{
                data: [50,25 , 25],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='ingles-compreensao-de-texto'){
                    window.location.href=('ingles-compreensao-de-texto.html')
                }
                else if(label=='ingles-interpretacao-de-figuras-de-linguagem'){
                    window.location.href=('ingles-interpretacao-de-figuras-de-linguagem.html')
                }
                if(label=='ingles-gramatica-estrutura-da-lingua'){
                    window.location.href=('ingles-gramatica-estrutura-da-lingua.html')
                }
