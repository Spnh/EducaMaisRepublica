...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Filosofia Antiga', 'Racionalismo', 'Empirismo' , 'Filosofia Medieval', 'Outros'],
            datasets: [{
                data: [35, 20, 15, 10, 20 ],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Filosofia Antiga'){
                    window.location.href=('../filosofia/filosofia-grecia.html')
                }
                else if(label=='Racionalismo'){
                    window.location.href=('../filosofia/filosofia-racionalismo.html')
                }
                if(label=='Empirismo'){
                    window.location.href=('../filosofia/filosofia-empirismo.html')
                ...
                if(label=='Filosofia Medieval'){
                    window.location.href=('../filosofia/filosofia-medieval.html')
                }
