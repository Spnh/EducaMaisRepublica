...
function abreTopico(topico){  
 ...
 $("#grafico").addClass("cursor")
        ...
        var dados = {
            labels: ['Figuras de Linguagem',  'Funções da Linguagem' , 'Gêneros Textuais', 'Interpretação Textual', 'Intertextualidade ', 'Linguagem Culta e Coloquial'],
            datasets: [{
                data: [8, 10, 43, 20, 8, 7],
                backgroundColor: [
                    'rgb(255, 0, 0)',
        ...
        var myPieChart = new Chart(ctx, config);
         myPieChart.canvas.addEventListener('click', function (event) {
            ...
            if (setores.length > 0) {
                ...
                if(label=='Figuras de Linguagem'){
                    window.location.href=('../Portugues/portugues-figuras-da-linguagem.html')
                }
                else if(label=='Funções da Linguagem'){
                    window.location.href=('../Portugues/portugues-funcoes-da-linguagem.html')
                }

                if(label=='Gêneros Textuais'){
                    window.location.href=('../Portugues/portugues-generos-textuais.html')
                }
                if(label=='Interpretação Textual'){
                    window.location.href=('../Portugues/portugues-interpretacao-textual.html')
                }
                if(label=='Intertextualidade'){
                    window.location.href=('../Portugues/portugues-intertextualidade.html')
                }
               if(label == 'Linguagem Culta e Coloquial'){
                  window.location.href=('../Portugues/portugues-linguagem-culta-coloquial.html')
                }
            }
        });
